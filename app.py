...
<div class="main-header">
    ...
    <p>Tác giả: Nguyễn Thị Thu - Trường Tiểu học Hùng An - ĐT: 0399769528</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Nguyễn Thị Thu - Trường Tiểu học Hùng An - ĐT: 0399769528</div>", unsafe_allow_html=True)
